...
use crate::qdrant::{
    qdrant_client, shard_key, ClearPayloadPoints, CountPoints, CountResponse,
    ...
    DiscoverResponse, FieldType, GetPoints, GetResponse, HealthCheckReply, HealthCheckRequest,
    PayloadIndexParams, PointId, PointStruct, PointVectors, PointsOperationResponse,
